...
class RoomController:
    ...
    def __init__(self):
        ...
        self._light = Light(2, 'Roomlight')
        self._partylight = NeoPixel (pin=17, numleds = 16, brightness=1)
    ...
    def stateEntered(self, state, event):
        ...
        if state == 0:
            ...
            self._display.showText(' Sentinel Mode \n   Activated')
            self._light.off()
            ...
            self._display.reset()
            self._display.showText('INTRUDER ALERT \n     LEAVE')
            self._light.on()
            ...
            self._display.reset()
            self._display.showText('   PARTY MODE \n     ENGAGED')
